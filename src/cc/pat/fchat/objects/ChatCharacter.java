...
public class ChatCharacter {
	...
	public void initNLN(JSONObject characterJSON) throws JSONException {
		identity = characterJSON.getString("identity");
		status = characterJSON.getString("status");
		gender = characterJSON.getString("gender");
	}
	...
	public void changeStatus(JSONObject statusJSON) throws JSONException {
		status = statusJSON.getString("status");
		statusMessage = statusJSON.getString("statusmsg");
	}
}
